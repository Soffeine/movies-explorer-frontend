// форма редактирования профиля: сделать так, чтобы можно было сохранять только когда пользователь что-то поменял
// лайки
// сохранение состояния чекбокса и результата поиска
// регистрация с авто-авторизацией
// переход незарегистрированных пользователей со страницы авторизации на main 
